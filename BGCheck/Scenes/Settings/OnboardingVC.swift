...
class OnboardingVC: UIViewController, KeyboardHandler {
    ...
    private let coatOfArmsPicture = UIImageView(image: .onboardingVCCoatOfArms)
    ...
    private func configureAddCaseButton() {
        ...
        addCaseButton.titleLabel?.font = .systemFont16Medium
    ...
    private func configureDoneButton() {
        ...
        doneButton.titleLabel?.font = .systemFont16Medium
    ...
    private func setupUI() {
        ...
        [casesView, casesTable].forEach {
            $0.leadingAnchor.constraint(equalTo: view.safeAreaLayoutGuide.leadingAnchor, constant: .spacing20).isActive = true
            $0.trailingAnchor.constraint(equalTo: view.safeAreaLayoutGuide.trailingAnchor, constant: -.spacing20).isActive = true
        }
